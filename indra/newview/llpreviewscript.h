...
protected:
    ...
    LLScriptEdCore(LLScriptEdContainer*       container,
...
public:
    ...
    void refreshCompileTargetUI(LLViewerRegion* region);

    std::string getCompileTarget() const;
    void        setCompileTarget(const std::string& compile_target);
    bool        isLuaCompileTarget() const;
    bool        isLuauLanguageTarget() const;
    ...
    static void onCompileTargetCommit(LLUICtrl* ctrl, void* userdata);
...
private:
    ...
    LLComboBox*                    mCompileTargetCombo = nullptr;
    bool                           mForceClose;
    LLPanel*                       mCodePanel;
...
protected:
    ...
    static void onLoadComplete(const LLUUID& uuid, LLAssetType::EType type, void* user_data, S32 status, LLExtStat ext_status);
