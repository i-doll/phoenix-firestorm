...
public:
    ...
    LLResourceUploadInfo(LLTransactionID        transactId,
    ...
    static bool findAssetTypeAndCodecOfExtension(const std::string& exten, LLAssetType::EType& asset_type, U32& codec,
                                                 bool bulk_upload = true);

protected:
    LLResourceUploadInfo(std::string            name,
                         std::string            description,
                         S32                    compressionInfo,
                         LLFolderType::EType    destinationType,
                         LLInventoryType::EType inventoryType,
    ...
    LLResourceUploadInfo(LLAssetID assetId, LLAssetType::EType assetType, std::string name);
...
{
public:
    LLNewFileResourceUploadInfo(std::string            fileName,
                                std::string            name,
                                std::string            description,
                                S32                    compressionInfo,
                                LLFolderType::EType    destinationType,
...
public:
    ...
    LLScriptAssetUpload(LLUUID taskId, LLUUID itemId, TargetType_t targetType, bool isRunning, LLUUID exerienceId, std::string buffer,
                        taskUploadFinish_f finish, uploadFailed_f failed);
    LLScriptAssetUpload(LLUUID taskId, LLUUID itemId, std::string compileTarget, bool isRunning, LLUUID exerienceId, std::string buffer,
                        taskUploadFinish_f finish, uploadFailed_f failed);
...
public:
    ...
    static void AssetInventoryUploadCoproc(LLCoreHttpUtil::HttpCoroutineAdapter::ptr_t& httpAdapter, const LLUUID& id, std::string url,
